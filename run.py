...
def start(message):
    bot.send_message(message.chat.id, 'Введи код с пачки стиков *neo/Kent* и других марок, которые импортирует ТОО «БРИТИШ АМЕРИКАН ТОБАККО КАЗАХСТАН ТРЕЙДИНГ».      ❗️ *Внимание* – можно добавлять только 14 кодов в неделю**')
